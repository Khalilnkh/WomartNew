...
!b(a.currentTarget).hasClass("")&&o.page()!=a.data.action&&o.page(a.data.action).draw("page")};l=0;for(h=f.length;l<h;l++)if(c=f[l],b.isArray(c))q(d,c);else{g=e="";switch(c){case "ellipsis":e="&#x2026;";g="";break;case "first":e=k.sFirst;g=c+(0<j?"":" ");break;case "previous":e=k.sPrevious;g=c+(0<j?"":" ");break;case "next":e=k.sNext;g=c+(j<n-1?"":" ");break;case "last":e=k.sLast;g=c+(j<n-1?"":" ");break;default:e=c+1,g=j===c?"active":""}e&&(i=b("<li>",
